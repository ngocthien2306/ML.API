...
async def trackVehicle(platenum: str,typeTransport:str,typeLicensePlate:str, file: Union[UploadFile,None] = None):
    ...
    ## Image DetectFace
    face_detected = DeepFace.detectFace(face, detector_backend='ssd', enforce_detection=False)
    ...
    result = await track_services.create_track_vehicle(embedding.model,face_detected[:,:,::-1]*255,platenum,img_detected,typeTransport, typeLicensePlate,img_detected, date_time, "AOOTEST") # "AOOTEST" is Const
